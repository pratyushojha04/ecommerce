    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('SHOPKEEPER', 'Shopkeeper'), ('ADMIN', 'Admin')], default='CUSTOMER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Dairy', 'Dairy'), ('Grocery', 'Grocery')], max_length=50)),
